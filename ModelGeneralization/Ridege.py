...
# score明显下降
ridge_reg=RidgeRegression(20,alpha=0.0001)
ridge_reg.fit(x_train,y_train)
plot_model(ridge_reg,x_test,y_test,color='b')

# 正则化，alpha=1，正则化项的权重，alpha越大，正则化项的权重越大，模型越简单
# score明显下降
ridge_reg=RidgeRegression(20,alpha=1)
ridge_reg.fit(x_train,y_train)
plot_model(ridge_reg,x_test,y_test,color='g')

# 正则化，alpha=100，正则化项的权重，alpha越大，正则化项的权重越大，模型越简单
# score开始上升，出现欠拟合情况
ridge_reg=RidgeRegression(20,alpha=100)
ridge_reg.fit(x_train,y_train)
plot_model(ridge_reg,x_test,y_test,color='y')
